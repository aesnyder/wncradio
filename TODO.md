...
- [x] **5. Service Worker Update & Verification**
  - [x] Bump PWA `CACHE_NAME` version in `sw.js`.
  - [x] Test the site locally (validate light/dark modes and mobile responsive grid scaling).
...
- [/] **6. UX & Aesthetic Enhancements (Designer Feedback)**
  ...
  - [x] Improve vertical spacing/grouping by increasing `.section-title` top margin from `1.5rem` to `2.5rem` on the homepage.
  ...
  - [x] Increase footer top margin (e.g., from `2rem` to `3rem`) to improve separation.
  - [x] Polish PWA offline indicator bar design.

- [/] **7. Emergency Resiliency & UX Improvements**
  - [x] **Make Emergency Buttons Visually Distinct**
  ...
  - [x] **Elevate Critical Actionable Data Above the Fold**
  ...
  - [x] **Expose Primary Frequencies Instantly**
  ...
  - [x] **Improve Dark Mode Button Contrast**
